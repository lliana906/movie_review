...
form_window = uic.loadUiType('./untitled.ui')[0]
...
class Exam(QMainWindow, form_window):
    def __init__(self):
        ...
        self.embedding_model = Word2Vec.load('./models/word2vec_moview.model')
    ...
    def combobox_slot(self):
        ...
        self.recommendation_by_title(title)
